...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1154: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1153: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1193: (a: number, b: number, c: number, d: number) => void;
